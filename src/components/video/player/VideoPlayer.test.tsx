...
describe('video player', () => {
  ...
  it('will reload a video including segment if the video url params change', () => {
    const data = {
      message: 'a whole segment',
      search: 'segmentStart=15&segmentEnd=40',
      expectedArgs: [
    ...
    const component = getComponent({ video }, store);
    ...
    expect(
      ...
      sameVideoWithShareCode.links.self.getOriginalLink(),
      { start: 15, end: 40 },
    );
  });
